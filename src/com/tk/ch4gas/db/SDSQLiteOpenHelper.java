...
public abstract class SDSQLiteOpenHelper {
	...
	{
		try {
			FileWriter	writer = new FileWriter("/storage/sdcard1/tk1.txt");
	...
	public File getDatabasePath(String name) {
		String EXTERN_PATH = null;
		 String mmm = android.os.Environment.getExternalStorageDirectory().getAbsolutePath()
		 + "/db/";
		if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)==true)
		{
			if(existSDcard()) {
				EXTERN_PATH = "/storage/sdcard1/db/";
			}else{
